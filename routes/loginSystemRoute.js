...
const {openLoginSystem, registerUser, openPasswordPage, createPassword, openLoginPage,loginUser, checkdb, forgetPass, displayList, openHomePage, logoutUser} = require('../controllers/controllerLoginSystem');
router.get('/login_system',openLoginSystem);
