...
const openLoginSystem = (req, res) => {
  res.render("login_system_views/index", {
    errMsg: "",
    id: 0,
    otp: 0,
    isReg: false,
...
const registerUser = async (req, res) => {
  ...
  const [errMsg, id, otp, isReg] = await insertUser(req.body);
...
const openPasswordPage = (req, res) => {
  ...
  res.render("login_system_views/password", {
    id: id,
    otp: otp,
    isSuccess: false,
    errMsg: "",
...
const createPassword = async (req, res) => {
  ...
  if (result.length == 0) {
    ...
    let resultPass = await updatePassword(password, id, u_otp);
...
const openLoginPage = (req, res) => {
  res.render("login_system_views/login", {
    email: "",
    errMsg: "",
    successMsg: "",
  });
